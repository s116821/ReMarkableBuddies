...
- [ ] 3.1 Announce changes, verify idle authorized device and preserve rollback/document/header state.
- [ ] 3.2 Validate actual rendered first/appended blocks and full native undo/redo with immediate before/after state; preserve header, prior answers and ink.
- [ ] 3.3 Add reusable native regression captures where applicable; restore original document/cache and agreed installed service state.

## 4. Review and completion

- [ ] 4.1 Reread new timestamped comments, verify every requirement, sync canonical specs and archive in this implementation PR.
- [ ] 4.2 Publish grouped actual evidence, obtain independent exact-head review and green checks, merge normally and verify release.
