...
- [ ] 1.1 Restore requested flags, exact inventory/conflicts, environment precedence and early value-free credential validation.
- [ ] 1.2 Enable app debug by default with validated level override and RUST_LOG fallback; keep image dumps opt-in.
- [ ] 1.3 Remove unsupported production branches; add capture-only and single immediate iteration examples using production components.
## 2. Guidance and regressions
- [ ] 2.1 Update public invocations, env and native guidance; inspect service/scripts/fixtures for removed flags.
