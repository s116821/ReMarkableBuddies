...
- [ ] 1.1 Reconcile full REM9 chronology; instrument bounded monotonic phase/operation measurement with no secrets.
...
- [ ] 2.5 Adjust navigation/settling/rendering only against measurements and preserve complete answer/history semantics.
## 3. Validation and delivery
- [ ] 3.1 Extend reachable simulator timing/state/fault coverage; exact positive and negative assertions, no history status switching.
